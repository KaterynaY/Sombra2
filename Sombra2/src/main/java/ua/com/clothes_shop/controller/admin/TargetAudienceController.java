...
public class TargetAudienceController {
	...
	public String update(@PathVariable int id, Model model, @PageableDefault Pageable pageable, @ModelAttribute("filter") SimpleFilter filter, Principal principal){
		...
		@PostMapping
		public String save(@ModelAttribute("targeta") @Valid TargetAudience targetAudience, BindingResult br, Model model, SessionStatus status, @PageableDefault Pageable pageable, @ModelAttribute("filter") SimpleFilter filter, Principal principal){
