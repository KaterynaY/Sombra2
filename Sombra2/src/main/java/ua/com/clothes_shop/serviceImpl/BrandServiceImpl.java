...
public class BrandServiceImpl implements BrandService{
	...
	@Override
	public List<Brand> findByTargetAudienceAndType(int targetAudienceId,
			int typeOfClothingId) {
		return brandDao.findByTargetAudienceAndType(targetAudienceId, typeOfClothingId);
	}
