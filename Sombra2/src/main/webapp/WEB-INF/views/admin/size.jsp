		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/size<custom:allParams/>">Size</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/admin/size" method="GET" modelAttribute="filter">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/size" method="POST" modelAttribute="size">
					<custom:hiddenInputs excludeParams="size"/>
					<div class="form-group">
		...
		<div class="row">
			<p>Note that size cannot be deleted if some item of clothing possesses this property.</p>
			...
			<c:forEach items="${page.content}" var="size">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/size/update/${size.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/size/delete/${size.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
