		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/targeta<custom:allParams/>">Target audience</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/admin/targeta" method="GET" modelAttribute="filter">
	...
	<div class="col-md-7 col-xs-12">
		...
		<div class="row">
			<p>Note that target audience cannot be deleted if some item of clothing possesses this property.</p>
			<div class="col-md-4 col-xs-4"><h3>Target audience</h3></div>
			<div class="col-md-4 col-xs-4"><h3>Update</h3></div>
			<div class="col-md-4 col-xs-4"><h3>Delete</h3></div>
		</div>
			<c:forEach items="${page.content}" var="audience">
				<div class="row">
					<div class="col-md-4 col-xs-4">${audience.category}</div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/targeta/update/${audience.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/targeta/delete/${audience.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
