 	...
 	.filter .control-label{
        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8 col-md-offset-2">
                <div class="row">
                    <div class="col-md-2">
                        <h3 class="zero-padding">MEN</h3>
                        <div class="clothing">                                           
                           <c:forEach items="${typesOfClothingMen}" var="type">
								<a href="/shopMen/${type.itemType}">${type.getItemType()}</a> <br>                      	
						   </c:forEach>
                           <br>
                        </div>
                        <br>
                                       <!-- filter -->
                       <form:form class="form-horizontal filter" action="/shopMen/${type}" method="GET" modelAttribute="filter">
                                ...
                                <div class="row dresses-pics"> 
						          <c:forEach items="${page.content}" var="itemOfClothing">
										...
										<p class="itemPrice">USD ${itemOfClothing.price}   
											<a href="/shopMen/${itemOfClothing.typeOfClothing.itemType}/addToCart/${itemOfClothing.id}<custom:allParams/>"><span class="itemBrand">Add <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></span></a>
										</p>	
										</div>
								  </c:forEach>
                                </div>
